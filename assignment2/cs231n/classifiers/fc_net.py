...
class FullyConnectedNet(object):
    ...
    def __init__(
        ...
        for i in range(self.num_layers):
          self.params['W' + str(i)] = np.random.randn(layer_dims[i], layer_dims[i+1]) * weight_scale
    ...
    def loss(self, X, y=None):
        ...
        for i in range(self.num_layers - 1):
          if self.normalization == "batchnorm":
            X, cache = affine_bn_relu_forward(
                      X, 
                      self.params['W' + str(i)], 
                      self.params['b' + str(i)], 
            ...
            X, cache = affine_ln_relu_forward(
                      X, 
                      self.params['W' + str(i)], 
                      self.params['b' + str(i)], 
                      self.params['gamma' + str(i)],
        ...
        dout, grads['W' + str(self.num_layers - 1)], grads['b' + str(self.num_layers - 1)] = \
