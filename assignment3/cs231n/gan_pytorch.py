...
def discriminator_loss(logits_real, logits_fake):
    ...
    loss = bce_loss(logits_real, torch.ones(logits_real.shape[0]).type(dtype))
    loss += bce_loss(logits_fake, torch.zeros(logits_fake.shape[0]).type(dtype))
